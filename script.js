...
//     mouseDown = true;
//     if (opacityState && randomState){
//         if(dict[event.target.id] === undefined || event.target.backgroundColor === "transparent" || pixelArray[dict[event.target.id]][3] === true){
//             draw(event, getOpacityColor(event, getRandomColor(3)));
//         }
//         else {
//             draw(event, getOpacityColor(event, pixelArray[dict[event.target.id]][2]));
//         }
...
// function clearBoard(){
//     for (let i = 0; i < pixelArrayTracker; i++){
//         pixelArray[i][0].style.backgroundColor = "transparent";
//     }
